...
class SPT3GPrototype(InstallableLikelihood):
    ...
    def loglike(self, dl_cmb, **params):
        ...
        ells_capse = np.arange(0, 3200)
        print(ells)
        #ells = np.arange(1, 3200)
        fg = self.fg
        ...
        for i, (cross_spectrum, cross_frequency) in enumerate(
            ...
            # Add CMB
            dl_model = dl_cmb[cross_spectrum][ells_capse]
...
#            print( cross_frequency, db_model[i])
    ...
    def logp(self, **data_params):
        ...
        return self.loglike(
            {"TT": Cl_TT_capse, "TE": Cl_TE_capse, "EE": Cl_EE_capse}, **data_params
        )
...
class TTTEEEemu(SPT3GPrototype):
    r"""
